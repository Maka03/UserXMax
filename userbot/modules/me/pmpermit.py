...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`Hello! This is an autogenerated message by userbot.\n\n`"
    "`You are seeing this message because I haven't approved you to message me.`"
    "`Its the bot that is online, not me so dont spam.\n\n`"
    "`sending more than 3 msgs will lead to block and report! Thanks`")
# =================================================================
